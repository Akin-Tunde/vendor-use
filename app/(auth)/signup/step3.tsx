  ...
  return (
    <SafeAreaView className="flex-1 bg-white">
      <View className="flex-row items-center px-6 pb-2">
        ...
        <Text className="flex-1 text-center text-primary font-bold text-sm">Step 2 of 5</Text>
        <View className="w-10" />
      </View>
      ...
      <View className="flex-row items-center justify-center px-5 mt-2">
        {[1, 2, 3, 4, 5].map((step) => (
          <React.Fragment key={step}>
            ...
            {step < 5 && <View className={`flex-1 h-[2px] mx-1 ${step < 2 ? 'bg-primary' : 'bg-slate-100'}`} />}
          </React.Fragment>
        ))}
      </View>
      ...
      <ScrollView className="flex-1 px-6 mt-3" showsVerticalScrollIndicator={false}>
        <View className="flex-row justify-between items-start">
          <View className="flex-1 pr-4">
            <Text className="text-2xl font-bold text-slate-900 leading-tight">Complete Your Store Profile</Text>
            <Text className="text-slate-500 mt-2 text-sm leading-5">This information will be visible on your store page.</Text>
          </View>
        ...
        <View className="pb-10">
          ...
          <View className="mb-5">
            ...
            <View className="flex-row items-center border border-slate-200 rounded-2xl px-4 h-14 bg-slate-50/50">
              <Store size={18} color="#4F26D9" style={{ marginRight: 12 }} />
              <TextInput
          ...
          <View className="mb-5">
            ...
            <View className="flex-row items-start border border-slate-200 rounded-2xl px-4 py-4 min-h-[100px] bg-slate-50/50">
              <Edit3 size={18} color="#4F26D9" style={{ marginRight: 12, marginTop: 4 }} />
              <TextInput
          ...
          <View className="mb-5">
            <Text className="font-semibold text-slate-700 mb-2">
              Business Type <Text className="text-slate-400 font-normal"></Text>
            </Text>
           <View className="flex-row items-center border border-slate-200 rounded-2xl px-4 h-14 bg-slate-50/50">
              <Store size={18} color="#4F26D9" style={{ marginRight: 12 }} />
              <TextInput
          ...
          <View className="mb-5">
            ...
            <View className="flex-row items-center border border-slate-200 rounded-2xl h-14 bg-slate-50/50">
              <View className="flex-row items-center px-3 border-r border-slate-200">
                ...
                <Text className="text-xs font-bold" style={{ marginLeft: 6 }}>+234</Text>
                <ChevronDown size={12} color="#666" style={{ marginLeft: 4 }} />
              </View>
              <TextInput placeholder="Enter business phone number" className="flex-1 px-4 text-sm text-slate-900" keyboardType="phone-pad" />
            </View>
          </View>
          ...
          <View className="mb-5">
            ...
            <View className="flex-row items-center border border-slate-200 rounded-2xl px-4 h-14 bg-slate-50/50">
              <Phone size={18} color="#4F26D9" style={{ marginRight: 12 }} />
              <TextInput placeholder="Enter alternative phone number" className="flex-1 text-sm text-slate-900" keyboardType="phone-pad" />
            </View>
          </View>
          ...
          <View className="mb-5">
            ...
            <View className="flex-row items-center border border-slate-200 rounded-2xl px-4 h-14 bg-slate-50/50">
              <MapPin size={18} color="#4F26D9" style={{ marginRight: 12 }} />
              <TextInput placeholder="Enter your store address" className="flex-1 text-slate-900 text-sm" />
            </View>
          </View>
          ...
          <View className="mb-5">
            <View className="flex-row items-center mb-2">
              <Text className="font-semibold text-slate-700" style={{ marginRight: 4 }}>Delivery Radius <Text className="text-slate-400 font-normal">(Optional)</Text></Text>
...
function ProfileInput({ label, icon: Icon, placeholder }: any) {
  return (
    <View>
      ...
      <View className="flex-row items-center border border-slate-200 rounded-2xl px-4 h-14 bg-slate-50/50">
        <Icon size={18} color="#4F26D9" style={{ marginRight: 12 }} />
...
function DropdownInput({ label, placeholder }: any) {
  return (
    <View className="flex-1">
      <Text className="font-semibold text-slate-700 mb-2">{label}</Text>
      <View className="flex-row items-center border border-slate-200 rounded-2xl px-4 h-14 bg-slate-50/50">
        <View className="w-5 h-5 bg-purple-100 rounded-md items-center justify-center" style={{ marginRight: 8 }}>
