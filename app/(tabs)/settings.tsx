    ...
    <SafeAreaView className="flex-1 bg-[#F8F9FE]">
      ...
      <View className="px-6 py-4 bg-white border-b border-slate-50 flex-row justify-between items-center">
        <View>
          ...
          <Text className="text-slate-400 text-xs">Manage your store profile and app preferences</Text>
        </View>
      ...
      <ScrollView className="flex-1" showsVerticalScrollIndicator={false}>
        ...
        <Pressable
          onPress={() => router.push('/more/store-profile' as any)}
        ...
        <View className="mx-6 mt-6">
          <Text className="font-bold text-slate-900 text-sm mb-2">Store Operations</Text>
        ...
        {/* Group 2: Preferences & App Settings */}
        <View className="mx-6 mt-6">
          ...
          <View className="bg-white border border-slate-100 p-4 rounded-[32px] shadow-sm space-y-1">
            ...
            <MenuLink
              icon={Sliders}
              label="App Settings"
              sub="Language, currency and security"
              bg="bg-purple-100"
              iconColor="#4F26D9"
...
function MenuLink({ icon: Icon, label, sub, bg, iconColor, red, onPress }: any) {
  return (
    <Pressable
      onPress={onPress}
      className="flex-row items-center justify-between py-3 border-b border-slate-50 active:bg-purple-50/20 rounded-xl px-2"
    >
