   ...
   return (
      <SafeAreaView className="flex-1 bg-[#F8F9FE]">
         ...
         <ScrollView className="flex-1" showsVerticalScrollIndicator={false}>
            {/* 2. Status Stepper */}
            <View className="px-6 py-6 bg-white border-b border-slate-50">
            ...
            <View className="px-6 mt-6">
               <View className="bg-white border border-slate-100 p-4 rounded-3xl shadow-sm">
                  ...
                  <Text className="text-slate-400 text-[10px] mt-1 leading-4">123 Banana Island Road, Ikoyi, Lagos, Nigeria</Text>
               </View>
            </View>
         ...
         <View className="px-6 py-6 border-t border-slate-50 bg-white flex-row space-x-3">
            ...
            <Pressable onPress={() => router.push('/orders/delivered')} className="flex-[2] h-14 bg-primary rounded-2xl flex-row justify-center items-center shadow-lg shadow-primary/30 active:bg-primary/90">
...
function FooterBtn({ icon: Icon, label }: any) {
   return (
      <Pressable className="flex-1 h-14 border border-slate-200 rounded-2xl flex-row items-center justify-center bg-slate-50 active:bg-slate-100">
